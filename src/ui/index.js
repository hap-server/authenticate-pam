...
import accessoryui, {AuthenticationHandlerConnection, AuthenticatedUser} from 'hap-server-api/accessory-ui';
...
accessoryui.registerAuthenticationHandlerComponent('PAM', AuthenticationHandlerComponent, 'Local users');
